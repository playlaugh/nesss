...
from apps.userena.managers import UserenaManager, UserenaBaseProfileManager
from apps.userena.utils import get_gravatar, generate_sha1, get_protocol, \
...
class UserenaBaseProfile(models.Model):
    ...
    def get_full_name_or_username(self):
        ...
        if user.first_name or user.last_name:
            ...
            name = _("%(last_name)s %(first_name)s ") % \
