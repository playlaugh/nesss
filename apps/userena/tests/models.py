...
from apps.userena.models import UserenaSignup, upload_to_mugshot
from apps.userena import settings as userena_settings
from apps.userena.tests.profiles.test import ProfileTestCase
from apps.userena.tests.profiles.models import Profile
from apps.userena.utils import get_user_model
...
class BaseProfileModelTest(ProfileTestCase):
    ...
    def test_get_mugshot_url_without_gravatar(self):
        ...
        userena_settings.USERENA_MUGSHOT_DEFAULT = 'http://127.0.0.1:8000'
        profile = Profile.objects.get(pk=1)
        self.failUnlessEqual(profile.get_mugshot_url(), 'http://127.0.0.1:8000')
