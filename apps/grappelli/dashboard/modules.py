...
# GRAPPELLI IMPORTS
from apps.grappelli.dashboard.utils import AppListElementMixin
...
class DashboardModule(object):
    ...
    def init_with_context(self, context):
        ...
        last ten visited pages::
            ...
            from apps.grappelli.dashboard import modules
...
class Group(DashboardModule):
    ...
    Here's an example of modules group::
        ...
        from apps.grappelli.dashboard import modules, Dashboard
